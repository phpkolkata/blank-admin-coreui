...
@Component({
  selector: 'app-discount-cause',
  templateUrl: './discount-cause.component.html',
  styleUrls: ['./discount-cause.component.css'],
})
export class DiscountCauseComponent implements OnInit {
  payment_style = 'percent';
  title = 'Discount Cause';
  localUrl = 'settings/discount-cause/';
  ...
  openDeleteModal(id: number) {
    ...
    this.bsModalRef.content.delSubject.pipe(take(1)).subscribe((res) => {
      if (res && res['success']) {
